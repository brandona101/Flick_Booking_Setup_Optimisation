...
SETUP_CSV  = os.path.join(DIR, 'phase1_setup_output.csv')
FL_CSV     = os.path.join(DIR, 'phase1_fl_assignments.csv')
SLOT_CSV   = os.path.join(DIR, 'phase1_slot_capacity.csv')
TECH_CSV   = os.path.join(DIR, 'phase1_tech_summary.csv')
OUT_HTML   = os.path.join(DIR, 'phase1_dashboard.html')
...
<head>
<meta charset="UTF-8">
<title>BSO Phase 1 Dashboard — GM-MCP</title>
